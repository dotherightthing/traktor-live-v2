...
This mitigates unresolved [text degradation caused by Cricut Design Space at print time](https://github.com/dotherightthing/push2-traktor-live/issues/4), otherwise text labels could be added directly to the cut file.
